          ...
          <div className="row">
            <div className="col-xl-9 col-lg-8">
              ...
              <div className="col-xl-3 col-lg-4">
                <button
                  type="button"
                  className={`tp-shop-mobile-filter-toggle ${isMobileFilterOpen ? "is-open" : ""}`}
                  aria-expanded={isMobileFilterOpen}
                  aria-controls="shop-sidebar-filters-right"
                  onClick={() => setIsMobileFilterOpen((open) => !open)}
                >
                  <span>Product Filters</span>
                  <span className="tp-shop-mobile-filter-arrow" aria-hidden="true"></span>
                </button>
                <div
                  id="shop-sidebar-filters-right"
                  className={`tp-shop-sidebar tp-shop-sidebar-mobile-collapse mr-10 ${isMobileFilterOpen ? "is-open" : ""}`}
                >
                  {/* filter */}
                  <PriceFilter
